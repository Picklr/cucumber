  ...
  render() {
    return (
      ...
      <div>
        ...
        <form
          onSubmit={(event) => {
            this.props.handleProductUpdateSubmit(event, this.props.selectedProduct.name, this.props.selectedProduct.price, this.props.selectedProduct.category, this.props.selectedProduct.brand, this.props.selectedProduct.productId)
          }}
